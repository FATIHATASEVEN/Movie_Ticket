...
int main() {
    ...
    struct Movie movies[MAX_MOVIES] = {
        {"Fight Club", 7.4, 243, 5, {"Bradd Pitt", "Morgan Freeman, Leanorda Banco"}},
        {"Seven", 8.3, 345, 9, {"Morgan Freeman", "Bradd Pitt, Shasan Lee"}},
        {"The Shawshank Redemption", 8.2, 395, 3, {"Reddy Vanga", "Ranbir Kapoor, Rashmika Mandanna"}},
        {"Schindler's List", 9.6, 265, 10, {"Vidhu Chopra", "Vikrant Massey, Medha Shankr"}},
        {"Inception", 9.9, 390, 8, {"Prashanth Varma", "Tejaja, Varalaxmi Sarathkumar"}},
    };
